...
public class PhoneBookTest {
    ...
    public static void main(String[] args) {
       ...
       System.out.println(p.findPhoneNumberByNameOrNameByPhoneNumber("Zeynep","05555568900"));
...
public String findPhoneNumberByNameOrNameByPhoneNumber(String name, String phoneNumber) {
    ...
    //public String find (String name,String phoneNumber){return getPhoneBook().findNameByPhone(name).orElse(getPhoneBook().findPhoneByName(phoneNumber).orElse(null));}
}